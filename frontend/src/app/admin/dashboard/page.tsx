...
import {
  ...
  GraduationCap, Award, Bell, Briefcase, BookMarked, Mic,
} from "lucide-react";
...
const quickLinks = [
  { href: "/admin/publications", label: "Journal Publications", icon: FileText,      color: "bg-blue-500",    hoverGlow: "hover:shadow-blue-500/20" },
  { href: "/admin/book-chapters", label: "Book Chapters", icon: BookOpen,      color: "bg-indigo-500",    hoverGlow: "hover:shadow-indigo-500/20" },
  { href: "/admin/invited-lectures", label: "Invited Lectures", icon: Mic,        color: "bg-rose-500",     hoverGlow: "hover:shadow-rose-500/20" },
