...
import {
  ...
  BookOpen, Bell, ChevronRight, Shield, Mic, Clock,
} from "lucide-react";
...
const navItems = [
  ...
  { href: "/admin/publications",     label: "Journal Publications",icon: FileText },
  ...
  { href: "/admin/ecrrb",            label: "ECRRB Applications",icon: FileText },
  { href: "/admin/ecrrb-certification", label: "Research Certs", icon: FileText },
