...
export function AboutHero() {
  ...
  useEffect(() => {
    ...
    api.get("/api/publications").then(res => {
      if (Array.isArray(res.data?.value)) setPubCount(res.data.value.length);
      else if (Array.isArray(res.data)) setPubCount(res.data.length);
    }).catch(console.error);
  }, []);
      ...
      <div className="container-academic">
        ...
        >
          ...
          <p className="text-lg text-[var(--text-muted)] leading-relaxed mb-8 max-w-2xl">
            ...
            <br/><br/>
            His research primarily focuses on the intersection of Marketing and Information Technology. He has published over {pubCount > 0 ? pubCount : 54} papers in esteemed journals and has authored two influential books on digital and internet marketing.
          </p>
          ...
          <div className="flex flex-wrap gap-4">
            {[
              ...
              { icon: BookOpen,      text: `${pubCount > 0 ? pubCount : "50+"} Publications` },
