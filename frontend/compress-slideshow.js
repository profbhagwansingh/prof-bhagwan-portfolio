...
const imgDir = path.join(__dirname, 'public', 'media', 'img', 'slideshow');
...
async function processImages() {
    ...
    for (const file of files) {
        ...
        try {
            ...
            // 1920x1080 is a good max bound for slideshows
    ...
    console.log(`Finished compressing ${count} images in ${imgDir}`);
}
