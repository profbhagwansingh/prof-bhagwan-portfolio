...
let ContentService = class ContentService {
    constructor(prisma, galleryService) {
        this.prisma = prisma;
        this.galleryService = galleryService;
    }
    async getHomepageData() {
        const [quickStats, courses, scholarsCount, invitedLecturesCount, publicationsCount, booksCount, bookChaptersCount, settings] = await Promise.all([
    ...
    async upsertInvitedLecture(data) {
        const { id, ...rest } = data;
        if (id) {
...
exports.ContentService = ContentService = __decorate([
    ...
    __metadata("design:paramtypes", [prisma_service_1.PrismaService, gallery_service_1.GalleryService])
], ContentService);
