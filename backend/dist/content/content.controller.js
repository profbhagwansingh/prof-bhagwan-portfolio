...
let ContentController = class ContentController {
    ...
    upsertBook(data) { return this.contentService.upsertBook(data); }
    deleteBook(id) { return this.contentService.deleteBook(id); }
    ...
    upsertQuickStat(data) { return this.contentService.upsertQuickStat(data); }
    deleteQuickStat(id) { return this.contentService.deleteQuickStat(id); }
    upsertInvitedLecture(data) { return this.contentService.upsertInvitedLecture(data); }
    deleteInvitedLecture(id) { return this.contentService.deleteInvitedLecture(id); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "getQuickStats", null);
__decorate([
    (0, common_1.Get)('invited-lectures'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "getInvitedLectures", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "upsertBook", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "deleteBook", null);
__decorate([
...
__decorate([
    (0, common_1.Post)('admin/quick-stats'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "upsertQuickStat", null);
__decorate([
    (0, common_1.Delete)('admin/quick-stats/:id'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "deleteQuickStat", null);
__decorate([
    (0, common_1.Post)('admin/invited-lectures'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "upsertInvitedLecture", null);
__decorate([
    (0, common_1.Delete)('admin/invited-lectures/:id'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ContentController.prototype, "deleteInvitedLecture", null);
