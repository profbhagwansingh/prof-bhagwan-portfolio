...
let PublicationsController = class PublicationsController {
    ...
    upsertBookChapter(data) { return this.pubService.upsertBookChapter(data); }
    deleteBookChapter(id) { return this.pubService.deleteBookChapter(id); }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], PublicationsController.prototype, "getBookChapters", null);
__decorate([
    (0, common_1.Get)('admin/chapters/all'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], PublicationsController.prototype, "getAllBookChapters", null);
__decorate([
    (0, common_1.Post)('admin/chapters'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN, client_1.Role.EDITOR),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], PublicationsController.prototype, "upsertBookChapter", null);
__decorate([
    (0, common_1.Delete)('admin/chapters/:id'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_guard_1.Roles)(client_1.Role.SUPER_ADMIN, client_1.Role.ADMIN),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PublicationsController.prototype, "deleteBookChapter", null);
