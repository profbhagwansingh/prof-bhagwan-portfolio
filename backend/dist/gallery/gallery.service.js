...
let GalleryService = GalleryService_1 = class GalleryService {
    ...
    async getPublicGalleryFolders() {
        return this.scanGalleryFolders(false);
    }
    async scanGalleryFolders(includeEmpty = true) {
